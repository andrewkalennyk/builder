<div class="{{strpos($value, ".svg") || strpos($value, ".avif") || strpos($value, ".png") || strpos($value, ".gif") ? 'transparent-image' : ''}}" style="position: relative; display: inline-block;" >
    <img class="image-attr-editable"
         ...
         @endif
         data-height="{{$height}}"
         @if (strpos($value, ".svg") || strpos($value, ".avif"))
            width="{{$width}}"
