...
namespace Admin\Builder\Http\Definitions;

use Illuminate\Database\Eloquent\Model;
use Illuminate\View\View;
use Admin\Builder\Http\Services\Listing;
use Illuminate\Support\Arr;
use Admin\Builder\Http\Fields\{Definition, Password, Virtual};
use Illuminate\Support\Facades\Validator;
use Admin\Builder\Http\Services\Actions;
use Admin\Builder\Libs\GoogleTranslateForFree;
use Admin\Builder\Http\Definitions\Traits\{CacheResource, CloneResource};
use Illuminate\Support\Str;
use Illuminate\Http\JsonResponse;
use Admin\Builder\Http\Interfaces\ResourceInterface;
...
class Resource implements ResourceInterface
{
    ...
    private function resultJsonSave($recordNew): array
    {
        return [
            ...
            'isTree' => is_subclass_of($recordNew, 'Admin\Builder\Tree')
        ];
    }
