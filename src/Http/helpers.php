...
use Admin\Builder\Models\TranslationsCms;
use Admin\Builder\Models\TranslationsPhrasesCms;
use Admin\Builder\Models\Language;
use Illuminate\Support\Facades\Cache;
use App\Cms\Definitions\Settings;
use Illuminate\Support\Facades\App;
use Admin\Builder\Services\Translate;
...
if (! function_exists('glide')) {
    ...
    function glide($source, array $options = [])
    {
        ...
        return (new Admin\Builder\Libs\Img())->get($source, $options);
    }
}
